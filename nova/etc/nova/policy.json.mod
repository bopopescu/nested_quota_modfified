{
    ...
    "project_admin":"role:project_admin and project_id:%(project_id)s",
    "admin_or_owner":  "is_admin:True or project_admin",
    ...
    "compute_extension:v3:os-quota-sets:root:update": "rule:admin_api",
    "compute_extension:v3:os-quota-sets:update": "rule:admin_or_owner",
    "compute_extension:v3:os-quota-sets:root:delete": "rule:admin_api",
    "compute_extension:v3:os-quota-sets:delete": "rule:admin_or_owner",
